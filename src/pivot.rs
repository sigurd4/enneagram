...
impl Pivot
{
    pub fn new(edge: Edge) -> Self
    {
        ...
        let (question, extroverted, introverted) = match edge
        {
            ...
            Catatonia => ("how will you gain security?", Action, Rest), // 851
    ...
    pub fn select(self) -> Edge
    {
        crate::select(
            ...
            &[self.extroverted, self.homeostatis, self.introverted]
                ...
                .map(|(affirmation, generator)| (&**affirmation, generator as &dyn Fn() -> Edge))
        )
    }
}